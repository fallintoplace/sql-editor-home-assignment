...
export const english: Copy = {
    ...
    common: {
        ...
        helpTourDescription: 'Use this panel as a fast tour of SQL examples, query workflows, observability, query structure, EXPLAIN, storage, dependencies, run evidence, and reference docs.',
        ...
        helpObservability: 'Observability',
        helpObservabilityDescription: 'Explore query workload history and local replica health on the active ClickHouse connection.',
        helpOpenObservability: 'Open observability',
