...
export const english: Copy = {
    ...
    common: {
        ...
        helpTourDescription: 'Use this panel as the fast product tour: query structure, ClickHouse EXPLAIN, MergeTree internals, materialized-view dependencies, retained run evidence, reference docs, and examples.',
