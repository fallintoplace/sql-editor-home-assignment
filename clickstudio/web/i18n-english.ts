...
export const english: Copy = {
    ...
    common: {
        ...
        helpAssistantDescription: 'Get help with ClickHouse SQL using your draft, schema, and relevant reference docs.',
        helpAssistantTitle: 'Ask. Review. Build from there.',
        helpAssistantExamplePrompt: 'Show daily event counts for the last 30 days',
        helpAssistantExampleContext: 'Current SQL draft · table schema · matched ClickHouse docs',
        helpAssistantExampleProposal: 'Group event timestamps by day, count the rows, and sort the timeline.',
        helpAssistantExampleSql: 'SELECT\n    toDate(event_time) AS day,\n    count() AS events\nFROM analytics.events\nWHERE event_time >= now() - INTERVAL 30 DAY\nGROUP BY day\nORDER BY day',
        helpOpenAssistant: 'Open AI assistant',
        helpMonitoring: 'Monitoring',
        helpMonitoringDescription: 'Review query workload and local replica health for the active ClickHouse connection.',
        helpOpenMonitoring: 'Open monitoring',
        ...
        helpDependencies: 'Data flow',
        helpDependenciesDescription: 'Follow how inserted rows move from a source table through a materialized view into a result table.',
        ...
        clickhouseSnippet: 'SQL template',
        clickhouseSnippets: 'SQL templates…',
        snippetSelectHelp: 'Choose a template to see what it does.',
        addQuery: 'Add query',
        addSnippetAsNewQuery: 'Add as new query',
