...
export const english: Copy = {
    ...
    common: {
        ...
        helpCenterDescription: 'Jump into ClickHouse query internals, EXPLAIN views, storage, dependencies, run comparison, documentation, and runnable examples.',
        ...
        helpTourDescription: 'Use this panel as the fast product tour: query structure, spatial results, ClickHouse EXPLAIN, MergeTree internals, materialized-view dependencies, retained run evidence, reference docs, and examples.',
