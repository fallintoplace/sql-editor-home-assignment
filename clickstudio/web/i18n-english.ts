...
export const english: Copy = {
    ...
    common: {
        ...
        helpCenterEyebrow: 'CLICKSTUDIO GUIDE',
        helpCenterTitle: 'Explore ClickHouse storage',
        helpCenterDescription: 'A quick guide to one of the most useful views in the object explorer.',
        helpFeatureLabel: 'STORAGE VISUALIZER',
        helpPartsTitle: 'MergeTree parts',
        helpPartsDescription: 'See the physical parts behind a MergeTree table. Compare their size, rows, and marks, grouped by partition.',
        helpExploreLive: 'OPEN THE LIVE VIEW',
        ...
        helpPartsPartitions: 'Grouped by partition',
        helpPartsMetrics: 'Compare size, rows, marks',
        helpPartsStates: 'Filter active and inactive parts',
        helpPartsMetadata: 'Inspect part metadata',
        helpPartsIllustration: 'Illustrative part map',
        helpPartsBySize: 'BAR WIDTH · SIZE',
        helpPartition: 'PARTITION',
        helpPartOne: 'Part 01',
        helpPartTwo: 'Part 02',
        helpPartThree: 'Part 03',
        helpPartsActive: 'Active parts',
        helpPartsBarNote: 'Relative compressed size',
        helpQuickStart: 'QUICK START',
        helpPartsOpenTitle: 'Open the parts view',
        helpPartsStepOne: 'Open Objects in the left panel.',
        helpPartsStepTwo: 'Select a table that uses a MergeTree engine.',
        helpPartsStepThree: 'Choose Visualize parts in the table details.',
        helpOpenObjects: 'Open Objects',
        helpWhenSelected: 'WHEN A PART IS SELECTED',
        helpPartsSelectionNote: 'Inspect its row and mark counts, compressed and uncompressed size, compression ratio, block range, disk, and modification time. The explorer is read-only.',
        examples: 'Examples',
