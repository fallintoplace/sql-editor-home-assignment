...
export const english: Copy = {
    ...
    common: {
        ...
        helpCenterTitle: 'Help & examples',
        helpCenterDescription: 'Browse SQL examples or inspect live MergeTree parts. SQL runs only when you choose Run.',
        helpPanelSections: 'Help sections',
