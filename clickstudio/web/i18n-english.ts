...
export const english: Copy = {
    ...
    common: {
        ...
        partsExplorerDescription: 'Active storage parts grouped by partition. Tile size reflects the selected measure.',
        partsMetricSize: 'Compressed size', partsMetricRows: 'Rows', partsMetricMarks: 'Marks',
        partsTreemap: 'Treemap', partsGalaxy: 'Galaxy', partsZoomPartition: 'Zoom into partition {partition}', partsActive: 'active parts', partsPartitions: 'partitions',
        partsShowingLimit: 'Showing the largest {count} parts.', partsLoading: 'Loading active parts…',
        partsEmpty: 'This table has no active parts.', partsSelectForDetails: 'Select a part to inspect its storage metrics.',
        ...
        partsModified: 'Modified', partsBackToTable: 'All partitions', partsFixture: 'Sample data',
