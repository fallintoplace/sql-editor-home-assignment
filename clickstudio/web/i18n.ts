...
export interface Copy {
    ...
    common: {
        ...
        helpPartsMetadata: string;
        helpPartsIllustration: string;
        helpPartsBySize: string;
        helpPartition: string;
        helpPartOne: string;
        helpPartTwo: string;
        helpPartThree: string;
        helpPartsActive: string;
        helpPartsBarNote: string;
        helpQuickStart: string;
        helpPartsOpenTitle: string;
        helpPartsStepOne: string;
        helpPartsStepTwo: string;
        helpPartsStepThree: string;
        helpOpenObjects: string;
        helpWhenSelected: string;
        helpPartsSelectionNote: string;
        examples: string;
        sqlExamples: string;
        examplesHint: string;
