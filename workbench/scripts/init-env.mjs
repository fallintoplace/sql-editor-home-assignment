...
CLICKHOUSE_USER=workbench_reader
CLICKHOUSE_PASSWORD=${secret()}
CLICKHOUSE_WRITER_USER=workbench_writer
CLICKHOUSE_WRITER_PASSWORD=${secret()}
CLICKHOUSE_IMPORT_TABLES=default.import_events
CLICKHOUSE_ADMIN_USER=workbench_admin
...
try {
    ...
    console.log('Created private .env. Read WORKBENCH_TOKEN from that file to sign in.');
}
catch (error) {
