...
import { executionLimitIssue, executionLimits, sameSavedContent, draftSaveStatus, scopedHistory, searchHistory, HISTORY_STATUSES } from '../../.workspace-build/shared/workbench-view.js';
...
function run(id, options = {}) {
    return { id, queryId: `cathedral-${id}`, connectionId: 'demo', sql: `SELECT '${id}'`, status: 'succeeded', createdAt: '2026-01-01T00:00:00Z', ...options };
}
...
const { rememberRunIds } = await import('../../.workspace-build/shared/workbench-view.js');
