...
export function RailButton({ icon, label, active, accent, onClick }: { icon: string; label: string; active?: boolean; accent?: boolean; onClick: () => void }) {
...
export function ExecutionBar({ run, eventState, onCancel, busy, scriptRunning }: { run: Run; eventState: string; onCancel: () => void; busy: boolean; scriptRunning: boolean }) {
