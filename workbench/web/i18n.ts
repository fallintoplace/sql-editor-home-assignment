...
const translations: Record<Exclude<Locale, 'en'>, Partial<Copy['app'] & Copy['common'] & Copy['auth']>> = {
    de: { language: 'Sprache', theme: 'Thema', beginner: 'Anfänger', expert: 'Experte', run: 'Ausführen', runStatement: 'Abfrage ausführen', cancel: 'Abbrechen', save: 'Speichern', saveRevision: 'Revision speichern', schema: 'Schema', history: 'Läufe', assistant: 'KI', results: 'Ergebnisse', chart: 'Diagramm', insights: 'Einblicke', open: 'Arbeitsbereich öffnen', opening: 'Arbeitsbereich wird geöffnet…' },
    es: { language: 'Idioma', theme: 'Tema', beginner: 'Principiante', expert: 'Experto', run: 'Ejecutar', runStatement: 'Ejecutar consulta', cancel: 'Cancelar', save: 'Guardar', saveRevision: 'Guardar revisión', schema: 'Esquema', history: 'Historial', assistant: 'IA', results: 'Resultados', chart: 'Gráfico', insights: 'Insights', open: 'Abrir espacio', opening: 'Abriendo espacio…' },
    nl: { language: 'Taal', theme: 'Thema', beginner: 'Beginner', expert: 'Expert', run: 'Uitvoeren', runStatement: 'Query uitvoeren', cancel: 'Annuleren', save: 'Opslaan', saveRevision: 'Revisie opslaan', schema: 'Schema', history: 'Runs', assistant: 'AI', results: 'Resultaten', chart: 'Grafiek', insights: 'Inzichten', open: 'Werkruimte openen', opening: 'Werkruimte openen…' },
    zh: { language: '语言', theme: '主题', beginner: '入门', expert: '专家', run: '运行', runStatement: '运行查询', cancel: '取消', save: '保存', saveRevision: '保存修订', schema: '架构', history: '运行记录', assistant: 'AI', results: '结果', chart: '图表', insights: '洞察', open: '打开工作区', opening: '正在打开工作区…' },
